<div class="bio-layout">
  ...
  <div class="education-timeline" aria-label="Education timeline">
    <article class="timeline-item">
      ...
      <p>Direct Ph.D. Student, Electronic and Information Engineering</p>
      <p class="timeline-advisor">Supervisor: Prof. Min Qiu</p>
    </article>
    <article class="timeline-item">
      <span class="timeline-date">Jan. 2025 – Aug. 2025</span>
      <h3>Westlake University</h3>
      <p>Visiting Student, Electronic and Information Engineering</p>
      <p class="timeline-advisor">Supervisor: Prof. Min Qiu</p>
    </article>
    <article class="timeline-item">
      <span class="timeline-date">May 2024 – Jan. 2025</span>
      <h3>University of California, Berkeley</h3>
      <p>Exchange Student, Department of Physics</p>
      <p class="timeline-advisor">Supervisor: Prof. Alexei V. Filippenko</p>
    </article>
    <article class="timeline-item">
      <span class="timeline-date">Sept. 2021 – June 2025</span>
      <h3>Zhejiang University of Technology</h3>
      <p>B.Sc. in Physics, Jianxing Honors Program</p>
      <p class="timeline-advisor">Supervisor: Prof. Tao Zhu</p>
    </article>
  </div>
</div>
